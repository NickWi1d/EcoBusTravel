...
const ShowTripInfo = ({ setIsShowUserTripInfo, selectedUserTrip, setTrips, setDeletedTrip, setIsDeleteTrip, PrintTheTicket }: { setIsShowUserTripInfo: React.Dispatch<React.SetStateAction<boolean>>, selectedUserTrip: CustomUserTrip, setTrips: React.Dispatch<React.SetStateAction<UserTrip[] | []>>, setDeletedTrip: React.Dispatch<React.SetStateAction<DeletedTrips>>, setIsDeleteTrip: React.Dispatch<React.SetStateAction<boolean>>, PrintTheTicket: () => void }) => {
    ...
    return (
        ...
        <div>
            ...
            <Button variant="outlined" size="small" color="info" className='ml-[2%]' onClick={PrintTheTicket}>
                Распечатать
            </Button>
        </div>
    )
