...
const BusesManagement = ({busesList, selectedBus, setSelectedBus, upDateBusInfoHandler}:{busesList:Bus[] | [], selectedBus:Bus, setSelectedBus: React.Dispatch<React.SetStateAction<Bus>>, upDateBusInfoHandler:(uid:string, typeOfBus:typeOfBus)=>void}) => {
    ...
    return (
        ...
        <Box sx={{ display: 'flex', height: '50px' }}>
          ...
          <Button variant='contained' className={`${styles.Btn} ml-[2%] w-[25%] flex items-center`}>Добавить автобус<img src="/icons8-плюс-32.png" className={'ml-3 pb-[2px]'} alt="" width={20} /></Button>
        </Box>
