...
const ChoosePlaces: React.FC<{ busType: typeOfBus | undefined, Seats: SeatsArray | [], amountOfTickets: number, selectedSeats: string[], setAmountOfTickets: React.Dispatch<React.SetStateAction<number>>, setSelectedSeats: React.Dispatch<React.SetStateAction<string[]>>, isAllSeatsSelected: boolean, setCurrentPassengers: React.Dispatch<React.SetStateAction<Passenger[]>> }> = ({ busType, Seats, amountOfTickets, setAmountOfTickets, selectedSeats, setSelectedSeats, isAllSeatsSelected, setCurrentPassengers }) => {
    ...
    return (
        <div>
            ...
            <div className={busType == 'M' ? styles.busM : styles.busL} onClick={pickSeat}>
